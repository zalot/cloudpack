...
echo -e "Starting hbase.replication.consumer @ $HOST_NAME ...\c"

STDOUT_LOG=$LOG_DIR/stdout.log
nohup $JAVA_HOME/bin/java $JAVA_OPTS -classpath $CONFIG_DIR:$LIB_JARS com.alibaba.hbase.replication.server.Consumer >> $STDOUT_LOG 2>&1 &
