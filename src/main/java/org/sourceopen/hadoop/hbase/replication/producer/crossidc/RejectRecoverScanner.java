 ...
 */
public class RejectRecoverScanner extends ZThread {
    ...
    public RejectRecoverScanner(){
    }

    public RejectRecoverScanner(ZNodeLock lock){
        this.setLock(lock);
    }

    public RejectRecoverScanner(Configuration conf){
        if (conf == null) return;
