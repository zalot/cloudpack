 ...
 */
public class HLogGroupZookeeperScanner extends ZThread {
    ...
    public HLogGroupZookeeperScanner(Configuration conf, ZooKeeper zoo) throws KeeperException,
                                                                                  InterruptedException, IOException{
        this(UUID.randomUUID().toString(), conf, zoo);
    }

    public HLogGroupZookeeperScanner(String name, Configuration conf, ZooKeeper zoo) throws KeeperException,
