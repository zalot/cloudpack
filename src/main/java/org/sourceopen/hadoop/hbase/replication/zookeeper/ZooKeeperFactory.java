package org.sourceopen.hadoop.hbase.replication.zookeeper;
...
public class ZooKeeperFactory {
    ...
    public static String          CLASS_ZOOKEEPER  = "org.apache.zookeeper.ZooKeeper";
    ...
    public static ZooKeeper getRecoveryZooKeeper(String url, int timeout, int rt, Watcher watcher) throws Exception {
        ...
        ctClass.writeFile();
        // ****************************************************************************
        ZooKeeper cc = (ZooKeeper) ctClass.toClass().newInstance();
        if (watcher != null) {
            cc.register(watcher);
        }
        return cc;
    ...
    public static void main(String[] args) throws Exception {
        ZooKeeper zk = ZooKeeperFactory.getRecoveryZooKeeper("h7:2181", 1000, 11, new NothingZookeeperWatch());
