package org.sourceopen.hadoop.zookeeper.connect.proxy;
...
public class ZookeeperProxy {
    ...
    protected static final Log    LOG              = LogFactory.getLog(ZookeeperProxy.class);
    ...
    public static ZooKeeper createZooKeeper(String url, int timeout, int rt, Watcher watcher) throws Exception {
        if (FINAL_CLASS == null) {
    ...
    public static void main(String[] args) throws Exception {
        ZooKeeper zk = ZookeeperProxy.createZooKeeper("h7:2181", 1000, 11, new NothingZookeeperWatch());
