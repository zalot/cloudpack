 ...
 */
public class RecoverableZooKeeper implements AdvZooKeeper {
    ...
    /**
     * delete is an idempotent operation. Retry before throw out exception. This function will not throw out
     * NoNodeException if the path is not existed
     * 
     * @param path
     * @param version
    ...
    /**
     * setData is NOT an idempotent operation. Retry may cause BadVersion Exception Adding an identifier field into the
     * data to check whether badversion is caused by the result of previous correctly setData
     * 
     * @param path
     * @param data
     * @param version
