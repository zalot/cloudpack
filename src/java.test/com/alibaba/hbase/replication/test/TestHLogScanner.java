...
public class TestHLogScanner extends BaseReplicationTest {
    ...
    public static HLogGroupZookeeperScanner rndShutDownScan(HLogGroupZookeeperScanner scan1, HLogGroupZookeeperScanner scan2) throws IOException, KeeperException, InterruptedException{
    ...
    private static HLogZookeeperPersistence rndShutDownDaoZk(HLogZookeeperPersistence dao1, HLogZookeeperPersistence dao2) throws InterruptedException, IOException {
